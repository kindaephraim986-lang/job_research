...
class _ProfileConfirmationScreenState extends State<ProfileConfirmationScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Column(
                children: [
                  ...
                  Text(
                    _firstValue(['filiere', 'filiere_specialite']),
                    style: const TextStyle(
                      fontSize: 14,
                      color: Colors.grey,
                    ),
            ...
            const SizedBox(height: 16),
            _buildProfileRow("Nom Complet", _firstValue(['nom'])),
            _buildProfileRow("Téléphone", _firstValue(['telephone'])),
            _buildProfileRow("Adresse Email", _firstValue(['email'])),
            _buildProfileRow("Filière / Spécialité", _firstValue(['filiere', 'filiere_specialite'])),
            _buildProfileRow("Sexe", _firstValue(['sexe', 'genre'])),
            _buildProfileRow("Âge", _firstValue(['age'])),
            _buildProfileRow("Lieu de résidence", _firstValue(['domicile', 'villeLieu'])),
  ...
  String _firstValue(List<String> keys) {
    for (final key in keys) {
      final value = widget.userData[key]?.trim();
