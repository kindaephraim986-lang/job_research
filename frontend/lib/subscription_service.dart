...
class SubscriptionService {
  ...
  static Future<bool> isCandidateMonthlySubscriptionActive() async {
    ...
    return result['success'] == true && (result['hasActiveSubscription'] == true || result['subscription'] != null);
  }
